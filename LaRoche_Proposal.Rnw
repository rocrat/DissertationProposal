...
Aitchison defines compositonal invariance as the statistical independence of $\mathbf{x}$ and $t$.  He then defines a test for compositional invariance based on the covariance between the composition formed by the basis through the closure operation and the basis size, $t$.
